...
namespace Agsoftware\Actividad\Setup\Patch\Data;

class ActividadV5 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $block_data_head= [
            'title' => 'Actividad ',
            'identifier' => 'actividad-economica',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/actividad.html'),
        ];
