...
namespace Agsoftware\Ecomers\Setup\Patch\Data;

class ecomersv3 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $block_data_head= [
            ...
            'identifier' => 'ecomers',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/ecomers.html'),
        ];
