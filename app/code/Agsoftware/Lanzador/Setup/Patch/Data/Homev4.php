...
namespace Agsoftware\Lanzador\Setup\Patch\Data;

class Homev4 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $data = [
            ...
            'content' => file_get_contents(__DIR__.'/html/home.html'),
