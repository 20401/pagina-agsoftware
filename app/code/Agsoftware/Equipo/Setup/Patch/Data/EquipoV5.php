...
namespace Agsoftware\Equipo\Setup\Patch\Data;

class EquipoV5 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $block_data_head= [
            'title' => 'User-equipo',
            'identifier' => 'equipo-user',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__ . '/html/equipo.html'),
        ];
