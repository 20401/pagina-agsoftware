...
class Recursos01 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            'title' => 'Recursos Negocio - Home',
            'identifier' => 'Rpn',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/recursos.html'),
        ];
