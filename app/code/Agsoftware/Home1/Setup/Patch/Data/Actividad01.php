...
namespace Agsoftware\Home1\Setup\Patch\Data;

class Actividad01 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            'title' => 'Actividad Economica - Home',
            'identifier' => 'Act-eco',
            'is_active' => 1,
