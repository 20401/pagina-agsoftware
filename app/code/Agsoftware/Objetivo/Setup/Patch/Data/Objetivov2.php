...
namespace Agsoftware\Objetivo\Setup\Patch\Data;

class Objetivov2 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            ...
            'identifier' => 'objetivo',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/objetivo.html'),
        ];
