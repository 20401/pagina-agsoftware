...
namespace Agsoftware\Tecnologias\Setup\Patch\Data;

class Tecnologiasv2 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $block_data_head = [
            'title' => 'Tecnologia',
            'identifier' => 'utilizamos',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__ . '/html/tecnologias.html'),
        ];
